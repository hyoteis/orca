...
export const LANGUAGE_SERVER_CUSTOM_COMMAND_RUNTIME_CAPABILITY =
  'language-server.custom-command.v1' as const
export const LANGUAGE_SERVER_MANAGED_INSTALL_RUNTIME_CAPABILITY =
  'language-server.managed-install.v1' as const
